...
\begin{tabular}{l|l|l|l|l|}
\cline{2-5}
\textbf{PCA Model}  & \textbf{Method}        & \textbf{\begin{tabular}[c]{@{}l@{}}Training\\ Mean Error\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Test\\ Mean Error\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Ratio\\ Test/Train\end{tabular}} \\ \cline{2-5}
...
\subsection{Problem Setting}
Firstly, a parametric model is created from MakeHuman. To achieve this, 8 sliders of the editor are varied between 3 positions and exported into MATLAB. The sliders and positions used, can be found in the appendix in table \ref{}. %TODO
...
The Ceres implementation is run for both parameteric models, fitting both models to the test set of \textit{before} point clouds. The resulting meshes are then compared to the ground truth by generating a error heat map for both models.
