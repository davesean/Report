...
\begin{titlepage}
	...
	\Huge
	\vspace{3.0cm}
	\textbf{\textsf{Inferring Human Body Parts and Correlations from Images, Point Clouds and Meshes}} \\[2.0cm]
	%\includegraphics*[width=0.4\textwidth]{figures/titlefigure} \\[4.0cm]
	\begin{figure}[h]
	\centering
	\begin{subfigure}{.4\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{figures/front01c}
	\end{subfigure}%
	\begin{subfigure}{.4\textwidth}
	  \centering
	  \includegraphics[width=0.8\linewidth]{figures/front01}
	\end{subfigure}
	\end{figure}
	\vspace{2.0cm}
	\sffamily
...
\include{ch03-methods}
\include{ch04-results-conclusion}
...
\includepdf{Aufgabenstellung_Semesterarbeit.pdf}
